...
export class RoutingService {
  ...
  nextMainPage(): Promise<boolean> {
    ...
    return this.router.navigate([
      (currentLang?.iso2 === DEFAULT_LANGUAGE ? '': '/'+currentLang?.iso2.toLowerCase())
